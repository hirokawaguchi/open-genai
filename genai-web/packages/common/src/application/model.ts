...
export const modelMetadata: Record<string, ModelMetadata> = {
  ...
  // doc を有効化（PDF/Word/Excel/テキストは backend がテキスト抽出して注入する）。
  'qwen2.5:7b': {
    flags: MODEL_FEATURE.TEXT_DOC,
    displayName: 'Qwen2.5 7B (ローカル)',
  },
  'qwen2.5:3b': {
    flags: { ...MODEL_FEATURE.TEXT_DOC, ...MODEL_FEATURE.LIGHT },
    displayName: 'Qwen2.5 3B (ローカル)',
  },
  'qwen2.5:0.5b': {
    flags: { ...MODEL_FEATURE.TEXT_DOC, ...MODEL_FEATURE.LIGHT },
    displayName: 'Qwen2.5 0.5B (ローカル)',
  },
  'llama3.1:8b': {
    flags: MODEL_FEATURE.TEXT_DOC,
    displayName: 'Llama 3.1 8B (ローカル)',
  },
  'gemma2:9b': {
    flags: MODEL_FEATURE.TEXT_DOC,
